...
class LocaleController extends Controller
{
    ...
    {
        $this->middleware(Authorize::using('manage:localization'));
     ...
     * Get group data
     */
    public function getGroup(Request $request, $group): array
    {
        return [
            'locales' => $this->availableLocales()->values(),
     ...
     */
    protected function getGroupTranslations(Request $request, $group): Collection
    {
     ...
     */
    protected function availableGroups(): Collection
    {
        $query = Translation::query()
        ...
        return $query->groupBy('name')->orderBy('name')->get();
    }

    /**
     * Get available locales data
     */
    protected function availableLocales(): Collection
    {
