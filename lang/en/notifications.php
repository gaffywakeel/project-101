...
return [
    ...
    'phone_token' => [
        ...
        'sms' => [
            'content' => ':token is your verification code, it expires in :duration minutes.',
        ],
    ],
    ...
    'email_token' => [
        ...
        'mail' => [
            'greeting' => 'Hi, :username',
            'subject' => 'OTP Request',
            'content' => '<b>:token</b> is your verification code, it expires in <b>:duration</b> minutes.',
        ],
    ],
    ...
    'peer_trade_started' => [
        ...
        'mail' => [
            'greeting' => 'Hi, :username',
            'subject' => 'Peer Trade Started (:id)',
            'content' => 'A new <b>:coin</b> peer trade of <b>:formatted_amount</b> (:value) has started.',
        ],

        'sms' => [
            'content' => 'A new :coin peer trade of :formatted_amount (:value) has started.',
        ],
    ...
    'peer_trade_canceled' => [
        ...
        'mail' => [
            'greeting' => 'Hi, :username',
            'subject' => 'Peer Trade Canceled (:id)',
            'content' => 'The peer trade with the ID: <b>:id</b> was canceled.',
        ],

        'sms' => [
            'content' => 'The peer trade with the ID: :id was canceled.',
        ],
    ...
    'peer_trade_confirmed' => [
        ...
        'mail' => [
            'greeting' => 'Hi, :username',
            'subject' => 'Peer Trade Marked as Paid (:id)',
            'content' => 'The peer trade with the ID: <b>:id</b> was marked as paid.',
        ],

        'sms' => [
            'content' => 'The peer trade with the ID: :id was marked as paid.',
        ],
    ...
    'peer_trade_completed' => [
        ...
        'mail' => [
            'greeting' => 'Hi, :username',
            'subject' => 'Peer Trade Completed (:id)',
            'content' => 'The peer trade with the ID: <b>:id</b> was completed.',
        ],

        'sms' => [
            'content' => 'The peer trade with the ID: :id was completed.',
        ],
    ...
    'peer_trade_disputed' => [
        ...
        'mail' => [
            'greeting' => 'Hi, :username',
            'subject' => 'Peer Trade Disputed (:id)',
            'content' => 'The peer trade with the ID: <b>:id</b> was disputed.',
        ],

        'sms' => [
            'content' => 'The peer trade with the ID: :id was disputed.',
        ],
